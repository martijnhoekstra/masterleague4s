...
case class Tournament(id: Long,
                      ...
                      end_date: LocalDate,
                      region: Option[Long],
                      stages: java.util.List[TournamentStage])
...
case class CalendarItem(date: Instant,
                        stage: Long,
                        is_live: Boolean,
                        streams: java.util.List[LiveStream],
                        matches: java.util.List[CalendarMatch])
